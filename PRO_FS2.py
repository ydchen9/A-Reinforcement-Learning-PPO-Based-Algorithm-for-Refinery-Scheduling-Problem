...
def PRO_opt(numT, Tlist, numL, Llist, DS1, DV1, DS_num, OCtank_ini, Otank_ini,Pri, Mode):
    ...
    [y_c,ycount,x_c,xcount,xycount,xy_c,QI_c,QIcount,QO_c,QOcount,Otankout_c,Otankoutcount,Q_c,Qcount,OINV_c,OINVcount,
            ...
            OCtankoutcount,OCtankout_c] = buildmodel(prob,
                                    numT, Tlist, numL, Llist, DS1, DV1, Pri, DS_num,  OCtank_ini, Otank_ini,Mode)
...
# numT,Tlist,numL1,Llist1,DS1,DV1,Pri,MODE
def printYield():
